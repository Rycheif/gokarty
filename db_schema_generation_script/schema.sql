...
;
ALTER TABLE "gokarty"."invoice" DROP CONSTRAINT IF EXISTS "Relationship1"
;
...
ALTER TABLE "gokarty"."invoice" ADD CONSTRAINT "Unique_Identifier8" PRIMARY KEY ("id_invoice","period","id_track","id_app_user")
;
